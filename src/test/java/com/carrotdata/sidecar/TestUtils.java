...
public class TestUtils {
  ...
  public static Configuration getHdfsConfiguration(SidecarConfig sidecarConfig, CacheConfig carrotCacheConfig)
  {
  ...
  private static void setCacheTypes(CacheConfig config) {
    ...
    String cacheTypes = com.carrotdata.sidecar.util.Utils.join(newTypes, ",");
  ...
  public static void printStats(Cache cache) {
    LOG.info("Cache[{}]: storage size={} data size={} items={} hit rate={}, puts={}, bytes written={}",
             cache.getName(), cache.getStorageAllocated(), cache.getStorageUsedActual(), cache.size(),
